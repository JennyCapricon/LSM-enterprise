...
const Terms = () => {
  const sections = [
    { title: 'Acceptance of Terms', content: 'By accessing and using JAY, you agree to be bound by these Terms of Service. If you do not agree, please do not use our platform.' },
    ...
    { title: 'Shipping & Delivery', content: 'We strive to process and ship orders within 1-2 business days. Delivery times vary by location. JAY is not responsible for delays caused by customs or shipping carriers.' },
    ...
    { title: 'Vendor Terms', content: 'Vendors listing on our marketplace agree to provide accurate product descriptions, maintain quality standards, and fulfill orders promptly. JAY reserves the right to remove listings that violate our policies.' },
    { title: 'Limitation of Liability', content: 'JAY shall not be liable for any indirect, incidental, or consequential damages arising from the use of our platform. Our total liability is limited to the purchase price of the product.' },
    ...
    { title: 'Contact', content: 'For questions about these terms, contact us at hello@jayfabrics.com.' },
  ];
